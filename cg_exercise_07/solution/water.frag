...
void main (void)
{
	...
	if(enable_fresnel > 0) {
        ...
        float cos_theta = dot(-cam_dir, world_normal);
	...
	add_color = vec4(reflected_light * reflectivity, reflectivity);
	mul_color = vec4(surface_transmission_color * (1.0 - reflectivity), 0);
